...
RSpec.describe TypedFields::ColumnMapping do
  describe ".value_column" do
    it "returns declared column as symbol" do
      expect(TypedFields::Field::Integer.value_column).to eq(:integer_value)
    end
  ...
  describe ".supported_operators" do
    it "returns default operators based on column type" do
      expect(TypedFields::Field::Integer.supported_operators).to include(:eq, :gt, :lt, :between)
    end

    it "allows override via .operators class method" do
      expect(TypedFields::Field::Boolean.supported_operators).to eq(%i[eq is_null is_not_null])
    end
  end
  ...
  describe ".default_operators_for" do
    ...
    it "returns numeric operators for integer_value fields" do
      ...
      ops = TypedFields::Field::Decimal.supported_operators
    ...
    it "returns json operators for json_value fields without override" do
      ...
      ops = TypedFields::Field::IntegerArray.supported_operators
    ...
    it "returns basic operators for unknown column types" do
      ...
      ops = TypedFields::Field::Json.supported_operators
